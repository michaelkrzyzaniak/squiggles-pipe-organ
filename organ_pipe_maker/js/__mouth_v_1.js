...
Mouth.prototype.draw_regular_model = function()
{
  ...
  var floor_height              = 13  * global_scaling;
  ...
  var fipple_nub_height         = 5  * global_scaling;
  var fipple_clearance_height   = Math.max(20  * global_scaling, fipple_nub_thickness - fipple_wall_thickness);
  var pipe_inset_height         = 20 * global_scaling;
