...
/*--------------------------------------------------------------------*/
typedef struct Opaque_STFT_Autocorr_Struct STFT_Autocorr;
typedef void (*stft_autocorr_onprocess_t)(void* onprocess_self, dft_sample_t* real, int N);

STFT_Autocorr* stft_autocorr_new    (int window_size /*power of 2 please*/, int overlap  /* 1, 2, 4, 8 */);
